<?php  
	...
	function showLatihan($id_materi, $connect) {
		...
		while($data_latihan = mysqli_fetch_array($hasil_latihan)) {
			...
			echo "<td><a href='admin_tambah_latihan.php?id=".$data_latihan['id']."' title='edit'><i class='fa fa-fw fa-file-o'></i></a> <a href='admin_tambah_latihan.php?id=".$data_latihan['id']."&del=1' title='hapus'><i class='fa fa-fw fa-trash'></i></a>  <a href='admin_soal_latihan.php?id=".$data_latihan['id']."'><i class='fa fa-fw fa-external-link'></i> Soal</a></td>";
			echo "</tr>";
			$i++;
		}
