    ...
    <section class="content">
       ...
       <div style="margin-top:70px; margin-left:70px;">
		       ...
		       <?php if($id_materi != 0) {
				...
				<a href="admin_tambah_evaluasi.php"><button class="btn btn-block btn-success" style="width:100px; margin-top:50px;">Tambah</button></a>
		...
		<?php if($id_materi != 0) {
			...
			<a href="admin_tambah_evaluasi.php"><button>Tambah</button></a> -->
